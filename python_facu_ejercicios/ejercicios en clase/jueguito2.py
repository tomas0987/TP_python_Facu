...
def pedirVidaHeroe():
    ventana_input = tk.Toplevel(ventana)
    ventana_input.title("Vida del héroe")
    ventana_input.geometry("300x150")

    tk.Label(ventana_input, text="Vida inicial del héroe:").pack(pady=10)
    entrada = tk.Entry(ventana_input)
    entrada.pack()
    ...
    tk.Button(ventana_input, text="Aceptar", command=confirmar).pack(pady=10)
